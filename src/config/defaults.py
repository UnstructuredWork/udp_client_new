...
_C.SERVER.FLASK = CN()
_C.SERVER.FLASK.HOST = []
_C.SERVER.FLASK.PORT = CN()
_C.SERVER.FLASK.PORT.RGBD = 0
_C.SERVER.FLASK.ROUTE = CN()
_C.SERVER.FLASK.ROUTE.RGB = "/kinect/rgb"
_C.SERVER.FLASK.ROUTE.DEPTH = "/kinect/depth"
_C.SERVER.FLASK.ROUTE.MONO = "/mono"
_C.SERVER.FLASK.SIZE = CN()
_C.SERVER.FLASK.SIZE.RGBD = [1920, 1080]
_C.SERVER.FLASK.SEND = False
...
_C.HW_INFO.MONO_DEPTH = CN()
_C.HW_INFO.MONO_DEPTH.TYPE = 'kinect'
_C.HW_INFO.MONO_DEPTH.SIZE = [1920, 1080]
_C.HW_INFO.MONO_DEPTH.USE = True
_C.HW_INFO.MONO_DEPTH.FPS = 30
_C.HW_INFO.MONO_DEPTH.MODEL = 'intel'
_C.HW_INFO.MONO_DEPTH.WEIGHT = "DPT_Hybrid" #"DPT_Large" #"MiDaS_small"
